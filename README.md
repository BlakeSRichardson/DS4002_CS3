...
The hook document outlining this case can be found in the file [CS2_Hook.pdf]. The rubric document containing assignment instructions and expectations can be found in the file     . 
## Data
